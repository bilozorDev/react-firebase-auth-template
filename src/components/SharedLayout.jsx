...
const navigation = [
  ...
  { name: "SignUp", href: "signup", icon: LogoutIcon, current: false },
];
                    ...
                    <a href="#" className="flex-shrink-0 group block">
                      <div className="flex items-center">
                        ...
                        <div className="ml-3">
                          ...
                          <button className="text-xs font-small text-gray-300 group-hover:text-gray-200" onClick={handleLogOut}>Sign out</button>
                        </div>
                      </div>
                    </a>
                    }
